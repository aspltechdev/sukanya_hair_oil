...
const IMAGES = {
  ...
  productImage: 'https://placehold.co/600x750/F5F0E8/6B7F4D?text=Sukanya+Hair+Oil',
  
  // Background decorative image - herbs, oils, ingredients
  bgDeco: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=600&q=80',
        ...
        <div className="product-showcase-container">
          ...
          <div className={`ps-header ${isVisible ? 'visible' : ''}`}>
            ...
            <h2 className="ps-title">
              <span className="ps-title-line">Premium Care,</span>
              <span className="ps-title-line ps-title-accent">Naturally</span>
            </h2>
