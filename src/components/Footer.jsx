...
const Footer = () => {
  ...
  const socialLinks = [
    { 
      icon: FaFacebookF, 
      label: 'Facebook', 
      href: 'https://facebook.com/sukanyahairoil',
      color: '#1877F2'
    },
    { 
      icon: FaInstagram, 
      label: 'Instagram', 
      href: 'https://instagram.com/sukanyahairoil',
      color: '#E4405F'
    },
    { 
      icon: FaYoutube, 
      label: 'YouTube', 
      href: 'https://youtube.com/@sukanyahairoil',
      color: '#FF0000'
    },
    { 
      icon: FaTwitter, 
      label: 'Twitter', 
      href: 'https://twitter.com/sukanyahairoil',
      color: '#1DA1F2'
    },
    { 
      icon: FaWhatsapp, 
      label: 'WhatsApp', 
      href: 'https://wa.me/917624920239',
      color: '#25D366'
    }
  ]
