      ...
      <div className="sw-container">
        ...
        <div className="sw-header">
          ...
          <div className="sw-badge">
            ...
            <span className="sw-badge-text">NOURISH NATURALLY</span>
            <span className="sw-badge-dot"></span>
          </div>

          <h2 className="sw-title">
            <span className="sw-title-light">Moments &</span>
<span className="sw-title-gold"> Glow Stories</span>
          </h2>
          ...
          <p className="sw-subtitle">
            Discover real transformations, hair care rituals,
ingredient stories, and the latest updates from
Sukanya Hair Oil's community.
          </p>
